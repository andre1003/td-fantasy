...
#include "TDFantasyCppPlayerController.generated.h"
#pragma endregion
...
UCLASS()
class ATDFantasyCppPlayerController : public APlayerController {
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent)
		...
		void ChangeCursorImage(int CursorType);
	#pragma endregion
